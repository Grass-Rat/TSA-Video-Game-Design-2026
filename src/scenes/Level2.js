...
export default class Level2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(width/2, 48, 
            "The Clockwork Room — Gears grind overhead. The path is broken and full of gaps.", 
            { fontSize: "13px", fill: "#cc8800", align: "center" }).setOrigin(0.5);

        // ── Platforms ───────────────────────
        this.addPlatform(180, floorTop - 60, "platform");   // first platform
        this.addPlatform(360, floorTop - 140, "platform");  // second
        this.addPlatform(540, floorTop - 220, "platform");  // third
        this.addPlatform(720, floorTop - 300, "platform");  // fourth

        // ── Goal ────────────────────────────
        this.goal = this.matter.add.image(780, floorTop - 360, "winplatform", null, { isStatic: true, label: "goal" });
    ...
    addPlatform(x, y, texture) {
        ...
        platSprite.setDisplaySize(160, 20); // scaled to playable size
